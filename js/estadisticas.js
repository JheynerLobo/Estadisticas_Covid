...
{  
  ...
  msg+="id='depart"+nid+"'>";
msg+="<option>Elija Departamento</option>";
...
function compararid(id1,id2){
  if(id1==id2){return true}
    ...
    //es un if para un caso especial que el Json trae, ya que cartagena tiene 13 en su id y 13 es el departamento de bolivar 
...
function irDepartamento(){
  var url='html/ref1.html?departamento='+leerSeleccionado('depart0');
